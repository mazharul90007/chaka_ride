...
const IMAGES = [
  "/assets/images/hiace/hiace-car1.jpg",
  "/assets/images/hiace/hiace-car2.jpg",
  "/assets/images/hiace/hiace-car3.jpg",
  "/assets/images/hiace/hiace-car4.jpg",
];
...
const FEATURE_ICONS: LucideIcon[] = [Bus, Route, Luggage, ShieldCheck];
...
export default function HiacePage() {
  const t = useTranslations("HiacePage");
