...
const IMAGES = [
  "/assets/images/sedan/sedan1.jpg",
  "/assets/images/sedan/sedan2.jpg",
  "/assets/images/sedan/sedan3.jpg",
  "/assets/images/sedan/sedan4.jpg",
];
...
const SPEC_ICONS: LucideIcon[] = [Users, Briefcase, AirVent, Fuel];

const FEATURE_ICONS: LucideIcon[] = [Armchair, Car, Sparkles, ShieldCheck];
...
export default function SedanPremiumPage() {
  const t = useTranslations("SedanPremiumPage");
