...
const IMAGES = [
  "/assets/images/sedan-economy/sedan-economy1.jpg",
  "/assets/images/sedan-economy/sedan-economy2.jpg",
  "/assets/images/sedan-economy/sedan-economy3.jpg",
  "/assets/images/sedan-economy/sedan-economy4.jpg",
];
...
const SPEC_ICONS: LucideIcon[] = [Users, Gauge, AirVent, Fuel];

const FEATURE_ICONS: LucideIcon[] = [BadgeDollarSign, Leaf, Gauge, ShieldCheck];
...
export default function SedanEconomyPage() {
  const t = useTranslations("SedanEconomyPage");
